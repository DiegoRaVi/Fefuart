...
| ID | Sev. | Problema |
|---|---|---|
| DB-001 | Alto | **Deriva de esquema.** 9 migraciones aplicadas en MySQL frente a 7 ficheros en el repositorio. `media_assets` y `operational_notifications` existen en la base de datos pero sus migraciones solo están en la rama `autotest`. Un `migrate:fresh` las destruiría. |
