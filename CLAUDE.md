...
- **`docs/V2-ROADMAP.md`** — **la fuente de verdad**: 34 decisiones arquitectónicas (D1–D34), 21 reglas de negocio (N1–N21), el esquema de base de datos objetivo, el diseño de la API y las 8 fases con su estado.
